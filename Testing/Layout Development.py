...
sm_square1 = displayio.TileGrid(sm_bitmap, pixel_shader=color_palette, x=82, y=4)
sm_square2 = displayio.TileGrid(sm_bitmap, pixel_shader=color_palette, x=82, y=16)
sm_square3 = displayio.TileGrid(sm_bitmap, pixel_shader=color_palette, x=82, y=28)
sm_square4 = displayio.TileGrid(sm_bitmap, pixel_shader=color_palette, x=82, y=40)
sm_square5 = displayio.TileGrid(sm_bitmap, pixel_shader=color_palette, x=82, y=52)
...
text10 = "Macro Set 10"  # overly long to see where it clips
